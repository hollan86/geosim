...
{
	Renderer.init();
	// Renderer.addShader(GL_VERTEX_SHADER, AssetManager::GetAppPath()  + "../shader/frame.vert");
	// Renderer.addShader(GL_FRAGMENT_SHADER, AssetManager::GetAppPath() + "../shader/frame.frag");
	Renderer.addShader(GL_VERTEX_SHADER, "../shaders/frame.vert");
